...
export default function Footer() {
  return (
    <footer className='flex h-fit w-full flex-col items-center justify-center bg-blue-400 text-white md:h-[250px]'>
      ...
      <div className='flex w-[90%] justify-center p-2 md:w-[50%] md:justify-start'>
        <Link
          href='/donate'
          className='flex h-[50px] w-[50%] flex-col items-center justify-center rounded-xl bg-white capitalize tracking-wider text-blue-500 md:w-[20%]'
        >
          Donate
        </Link>
      </div>
